...
def create_mel_bank(running_config):
    ...
    samples = int(running_config['MIC_RATE'] * running_config['N_ROLLING_HISTORY'] / (2.0 * running_config['FPS']))
    mel_y, (_, mel_x) = melbank.compute_melmat(num_mel_bands=running_config['N_FFT_BINS'],
